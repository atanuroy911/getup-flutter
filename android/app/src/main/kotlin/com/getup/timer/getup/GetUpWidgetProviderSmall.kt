...
class GetUpWidgetProviderSmall : HomeWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            val taskText = widgetData.getString("widget_next_task", state)
            ...
            views.setTextViewText(R.id.widget_state, taskText)
